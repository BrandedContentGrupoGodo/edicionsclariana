(() => {
      ...
      const safetyCssHref = "https://brandedcontentgrupogodo.github.io/edicionsclariana/20260713-generalitat-brl/assets/css/safety-widget.css?v=20260713a";
        ...
        const ITEMS = [
          {
            ...
            level: "no",
            pill: "No són segures!",
            whyTitle: "No són segures!",
            why:
              "No filtren prou, encara menys els rajos ultraviolats i infrarojos; la radiació solar continua danyant la retina",
          ...
          },
          {
            ...
            name: "Càmera sense filtre",
            cardLabel: "Càmera\nsense filtre",
            level: "no",
            pill: "No és segura!",
            whyTitle: "No és segura!",
            why:
              "Mirar a través del visor o de l'objectiu pot concentrar la llum. Hi ha risc per als ulls i per al sensor si no hi ha filtre solar",
          ...
          },
          {
            ...
            level: "no",
            pill: "No és segur!",
            whyTitle: "No és segur!",
            why: "No és un filtre solar i no protegeix si mires el Sol directament",
          ...
          {
            id: "gafas-eclipse",
            name: "Ulleres d'eclipsi homologades",
            cardLabel: "Ulleres\nd'eclipsi\nhomologades",
            level: "si",
            pill: "Sí que són segures",
            whyTitle: "Sí que són segures!",
            why:
              "Si estan en bon estat, sense ratlles, forats ni plecs, i compleixen la norma DIN EN ISO 12312-2:2015, són adequades per a la visió directa",
          ...
          {
            id: "visor-homologado",
            name: "Visor solar homologat",
            cardLabel: "Visor\nsolar\nhomologat",
            level: "si",
            pill: "Sí que és segur",
            whyTitle: "Sí que és segur!",
            why:
              "És un visor certificat per a l'observació solar directa i compleix els requisits de la norma DIN EN ISO 12312-2:2015",
          ...
          },
          {
            ...
            name: "Filtre solar professional",
            cardLabel: "Filtre\nsolar\nprofessional",
            level: "si",
            pill: "Sí que és segur",
            whyTitle: "Sí que és segur!",
            why:
              "Està dissenyat per bloquejar la radiació en el rang adequat: llum visible, ultraviolada i infraroja",
          ...
          {
            id: "soldador-14",
            name: "Filtre de soldador",
            cardLabel: "Filtre de\nsoldador",
            level: "no",
            pill: "No és segur!",
            whyTitle: "No és segur!",
            why:
              "No és un mètode homologat per a l'observació solar directa. No garanteix el filtratge de radiació com un filtre solar certificat",
          ...
          },
          {
            id: "radiografia",
            name: "Radiografia",
            cardLabel: "Radiografia",
            level: "no",
            pill: "No és segura!",
            whyTitle: "No és segura!",
            why: "No garanteix el bloqueig de la radiació perillosa",
          ...
          },
          {
            ...
            pill: "No és segur!",
            whyTitle: "No és segur!",
            why: "No filtra la llum solar de manera fiable",
          ...
          },
          {
            ...
            pill: "No és segur!",
            whyTitle: "No és segur!",
            why: "Enfosqueix la vista, però no protegeix adequadament davant de la radiació ultraviolada i infraroja",
...
<div class="w" role="group" aria-label="Simulador de seguretat per observar l'eclipsi (visió directa)">
            <div class="top">
              <div class="view" id="view">
                ...
                <div id="bigWrap" class="bigWrap" aria-hidden="true">
                  ...
                  <button id="bigDismiss" class="bigDismiss" type="button" aria-label="Treure objecte del visualitzador"></button>
                </div>
                <div class="viewMode" aria-hidden="true">Visió directa simulada</div>
                <div class="viewPrompt" aria-hidden="true">
                  <div class="viewPromptCard">
                    <p class="viewPromptTitle" id="viewPromptTitle">Arrossega aquí un objecte</p>
                    <p class="viewPromptBody" id="viewPromptBody">per saber si el seu ús és segur</p>
                  </div>
                </div>
                ...
                <div class="bottomHint">
                  <div id="hintCopy">Arrossega un objecte sobre el cel per veure l'eclipsi a través seu i saber si és segur per observar-lo</div>
                  <div class="right">Visió directa simulada</div>
                </div>
              </div>

              <aside class="panel" id="panel" aria-live="polite">
                <h3 class="panelTitle">Amb què és segur observar l'eclipsi de Sol?</h3>
                <p class="panelIntro" id="panelIntroCopy">
                  Prova d'arrossegar un objecte al visualitzador de l'esquerra per comprovar si permet observar l'eclipsi amb seguretat
                </p>
            ...
            <div class="trayWrap" id="trayWrap">
              <button class="trayToggle" id="trayToggle" type="button" aria-expanded="false" aria-controls="trayPanel">
                <span class="trayToggleText">
                  <span class="trayToggleLabel" id="trayToggleLabel">Objectes per provar</span>
                  <span class="trayToggleHint" id="trayToggleHint">Toca per desplegar la safata</span>
                </span>
              ...
              <div class="trayScrollUI" id="trayScrollUI" aria-hidden="true">
                <button class="trayScrollBtn prev" id="trayScrollPrev" type="button" tabindex="-1" aria-label="Desplaçar la safata cap a l'esquerra"></button>
                <div class="trayScrollTrack" id="trayScrollTrack">
                  <div class="trayScrollThumb" id="trayScrollThumb"></div>
                </div>
                <button class="trayScrollBtn next" id="trayScrollNext" type="button" tabindex="-1" aria-label="Desplaçar la safata cap a la dreta"></button>
              </div>
              <div class="legend" aria-label="Llegenda">
                <div class="legItem"><span class="dot red"></span><span>Totalment desaconsellats (risc greu de dany ocular)</span></div>
                <div class="legItem"><span class="dot green"></span><span>Aconsellats, tot i que només durant menys d'un minut d'ús</span></div>
              </div>
            </div>
          </div>
        `;
        ...
        const DESKTOP_HINT_TITLE =
          "Arrossega aquest objecte al cel per comprovar si permet observar l'eclipsi amb seguretat";
        const MOBILE_HINT_TITLE =
          "Toca aquest objecte per portar-lo al cel i comprovar si permet observar l'eclipsi amb seguretat";
        ...
        function updateTraySelection(activeBtn = null) {
          ...
          Array.from(tray.children).forEach((el) => {
            ...
            el.setAttribute(
              "aria-label",
              active && tapMode ? `${itemName}. Toca per tornar-lo a la safata.` : itemName
            );
          });
        }
        ...
        function updateMobileTrayCopy() {
          ...
          if (!mqCompact.matches) {
            trayToggleLabel.textContent = "Objectes per provar";
            trayToggleHint.textContent = "Arrossega un objecte al visualitzador";
            return;
          }

          if (usesTapTrayMode()) {
            trayToggleLabel.textContent = mobileActive ? mobileActive.it.name : "Objectes per provar";
            trayToggleHint.textContent = mobileActive
              ? "Fes lliscar la safata per canviar d'objecte"
              : "Fes lliscar la safata per veure'n més";
            return;
          }
        ...
        function applyMobileCopy() {
          ...
          if (viewPromptTitle) {
            viewPromptTitle.textContent = isTapMode ? "Toca un objecte" : "Arrossega aquí un objecte";
          }

          if (viewPromptBody) {
            viewPromptBody.textContent = isTapMode
              ? "per saber si el seu ús és segur"
              : "per saber si el seu ús és segur";
          }

          if (hintCopy) {
            hintCopy.textContent = isTapMode
              ? "Toca un objecte de la safata per veure'l en gran. Pots moure'l dins del cel i tornar-lo tocant l'aspa o la seva targeta."
              : "Arrossega un objecte sobre el cel per veure l'eclipsi a través seu i saber si és segur per observar-lo.";
          }

          if (panelIntroCopy) {
            panelIntroCopy.textContent = isTapMode
              ? "Toca un objecte de la safata per portar-lo al visualitzador i comprovar si permet observar l'eclipsi amb seguretat. Pots moure'l dins del cel i tornar-lo amb l'aspa o tocant de nou la seva targeta."
              : "Prova d'arrossegar un objecte al visualitzador de l'esquerra per comprovar si permet observar l'eclipsi amb seguretat.";
          }
        ...
        root.innerHTML = `<link rel="stylesheet" href="${safetyCssHref}"><div class="safety-widget-error">
          El widget ha fallat per un error de JavaScript. Obre la consola per veure'n el detall.
        </div>`;
