...
document.addEventListener("DOMContentLoaded", (event) => {
  ...
  allImages.forEach((blah) => {
    gsap.to(blah, {
      y: 200,
      scrollTrigger: {
        trigger: blah.parentElement,
        scrub: true
      }
    });
  });
...
app2.controller("uiCtrl2", function ($scope2, $timeout2) {
   var states2 = ["state0", "state1", "state2", "state3"],
      initialState2 = 0,
      currentState2 = initialState2,
      totalStates2 = states2.length,
      finalState2 = totalStates2 - 1,
      timer2;
   $scope2.currentState2 = states2[currentState2];

   function change2() {
      if (currentState2 < finalState2) {
         currentState2++;
         $scope2.currentState2 = states2[currentState2];
      } else {
         currentState2 = initialState2;
      ...
      if (currentState2 == finalState2) {
         $timeout2.cancel(timer2);
      }
   }

   $scope2.changeState2 = function () {
      change2();
   };

   $scope2.autoState2 = function () {
      timer2 = $timeout2($scope2.autoState2, 300);
      change2();
   };
});
...
app.controller("uiCtrl3", function ($scope, $timeout) {
   var states = ["state0", "state1", "state2", "state3"],
      initialState = 0,
      currentState = initialState,
      totalStates = states.length,
